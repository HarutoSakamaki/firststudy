...
<?php
    ...
    if(isset($_POST['search'])){
        ...
        try{
            $query = 'SELECT pk_id_company , nm_company , su_numberofemployees FROM tbm_company_kiso WHERE '.$companyterms.$employeesterms.' AND flg_del = false ORDER BY su_numberofemployees DESC';
            /* echo $query; */
